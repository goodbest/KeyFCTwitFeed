...
$TweetPHP = new TweetPHP(array(
  ...
  'cache_file'            => dirname(__FILE__) . '/cache/html/rule_'.$list_type.'.txt', // Where on the server to save the cached formatted tweets
  'cache_file_raw'        => dirname(__FILE__) . '/cache/html/rule_array_'.$list_type.'.txt', // Where on the server to save the cached raw tweets
